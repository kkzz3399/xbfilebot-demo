...
# 首页链接占位
OFFICIAL_CHANNEL_URL = os.environ.get("OFFICIAL_CHANNEL_URL", "https://t.me/your_official_channel_here")
VIP_GROUP_URL = os.environ.get("VIP_GROUP_URL", "https://t.me/your_vip_group_here")
